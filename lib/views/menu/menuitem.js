...
var MenuItem = function MenuItem(_ref) {
    ...
    return _react2.default.createElement(_item.Item, _extends({}, other, {
        'data-value': menuValue,
        link: true }));
};

MenuItem.propTypes = _extends({}, _item.Item.propTypes, {
    /**
     * Is item active
     */
...
MenuItem.defaultProps = _extends({}, _item.Item.defaultProps);
