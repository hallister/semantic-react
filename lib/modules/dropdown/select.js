    ...
    _createClass(Select, [{
        ...
        value: function componentWillMount() {
            ...
            _react2.default.Children.forEach(this.props.children, function (child) {
                _this2.validOptions[child.props.children] = child.props.value;
            });
        }
    }, {
            ...
            _react2.default.Children.forEach(this.props.children, function (child) {
                if (child.type === _modules.Option) {
                    ...
                    if (_this3.props.multiple) {
                        ...
                        if (_this3.state.selected.indexOf(child.props.children) > -1) {
                            selected = true;
                        }
                    }
                    ...
                    if (match && !selected) {
                        newChildren.push(_react2.default.cloneElement(child, {
                            ...
                            active: _this3.state.selected == child.props.children && !_this3.props.search,
                            onClick: _this3.onOptionClick.bind(_this3, child.props.children)
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _elements.Label,
                            {
                                component: 'a',
                                key: label,
                                onClick: _this4.onLabelClick.bind(_this4, label),
                                style: { display: 'inline-block' }
                            },
                            label,
                            _react2.default.createElement(_elements.Icon, {
                                name: 'close',
                                onClick: _this4.onCloseOption.bind(_this4, label) })
                        )
                    );
                });
            }
        ...
        value: function formatValue() {
            ...
            if (this.props.multiple) {
                var _ret = function () {
                    ...
                    _this5.state.selected.forEach(function (item) {
                        selected.push(_this5.validOptions[item]);
                    });
        ...
        value: function isMatch() {
            ...
            if (this.refs.search) {
                ...
                for (var name in this.validOptions) {
                    var text = this.props.ignoreCase ? name.toLowerCase() : name;
...
exports.Select = Select = (0, _decorator2.default)(Select);
