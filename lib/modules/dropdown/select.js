...
var Select = (_temp = _class = function (_React$Component) {
    ...
    _createClass(Select, [{
        ...
        value: function renderDropdownText() {
            ...
            var searchPosition = _props6.searchPosition;
     ...
     * Selected value
     */
    selected: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.number])),
    /**
     ...
     */
    onSearchStringChange: _react2.default.PropTypes.func
